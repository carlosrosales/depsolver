...
#include "constants.h"
#include "forceMultipole_tria6.h"
                         ...
                         double **vMatParam, double *vProbParam, double *F)
{
    ...
    if(nOrder > 1){
        F[0] += C[2]*(E[2][0][0]*E[3][0][0] + E[0][2][0]*E[1][2][0] + E[0][0][2]*E[1][0][2] + (E[1][1][0]*E[2][1][0] + E[1][0][1]*E[2][0][1] + E[0][1][1]*E[1][1][1])); /* Fx (n=2) */
        F[1] += C[2]*(E[2][0][0]*E[2][1][0] + E[0][2][0]*E[0][3][0] + E[0][0][2]*E[0][1][2] + (E[1][1][0]*E[1][2][0] + E[1][0][1]*E[1][1][1] + E[0][1][1]*E[0][2][1])); /* Fy (n=2) */
        F[2] += C[2]*(E[2][0][0]*E[2][0][1] + E[0][2][0]*E[0][2][1] + E[0][0][2]*E[0][0][3] + (E[1][1][0]*E[1][1][1] + E[1][0][1]*E[1][0][2] + E[0][1][1]*E[0][1][2])); /* Fz (n=2) */

        /* Contribution to the force from octupolar term (n = 3) */
        if(nOrder > 2){
            F[0] += C[3]*(E[3][0][0]*E[4][0][0] + E[0][3][0]*E[1][3][0] + E[0][0][3]*E[1][0][3] + (E[2][1][0]*E[3][1][0] + E[2][0][1]*E[3][0][1] + E[1][2][0]*E[2][2][0] + E[1][0][2]*E[2][0][2] + E[0][2][1]*E[1][2][1] + E[0][1][2]*E[1][1][2]) + E[1][1][1]*E[2][1][1]); /* Fx (n=3) */
            F[1] += C[3]*(E[3][0][0]*E[3][1][0] + E[0][3][0]*E[0][4][0] + E[0][0][3]*E[0][1][3] + (E[2][1][0]*E[2][2][0] + E[2][0][1]*E[2][1][1] + E[1][2][0]*E[1][3][0] + E[1][0][2]*E[1][1][2] + E[0][2][1]*E[0][3][1] + E[0][1][2]*E[0][2][2]) + E[1][1][1]*E[1][2][1]); /* Fy (n=3) */
            F[2] += C[3]*(E[3][0][0]*E[3][0][1] + E[0][3][0]*E[0][3][1] + E[0][0][3]*E[0][0][4] + (E[2][1][0]*E[2][1][1] + E[2][0][1]*E[2][0][2] + E[1][2][0]*E[1][2][1] + E[1][0][2]*E[1][0][3] + E[0][2][1]*E[0][2][2] + E[0][1][2]*E[0][1][3]) + E[1][1][1]*E[1][1][2]); /* Fz (n=3) */
        }
    }
