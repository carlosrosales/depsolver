...
* E[][][][] for the 3 dimensions and each node.                               *
* Works for linear interpolation in triangular elements (3-noded triangles).  *
* These are some examples:                                                    *
*                                                                             *
* Efield[0][1][0][0] = Ex @ node 1                                            *
* Efield[0][0][1][0] = Ey @ node 1                                            *
* Efield[0][2][0][0] = dEx/dx @ node 1                                        *
* Efield[0][1][0][1] = dEx/dz = dEz/dx @ node 1                               *
* Efield[2][0][1][3] = d3Ez/dydz2 = d3Ey/dz3 @ node 3                         *
*                                                                             *
...
int intDE_tria3(unsigned int nOrder, double X[3][3], double *Xeval, 
                double Efield[][7][7][7])
{
