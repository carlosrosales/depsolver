 ...
 *
 * @file
 * Definition of the four functions that perform the matrix assembly for
 * depSolver: electricFormA_tria3, electricFormA_tria6, electricFormFullA_tria3,
 * electricFormFullA_tria6.
 */
