...
#include "forceMST_tria3.h"

int forceMST_tria3(double **mNodes, unsigned int **mElems, 
                   unsigned int *vBCType, double *vB, double Eps, 
                   double **Fce, double **Xce, double *Fcm, double *Xcm)
{
